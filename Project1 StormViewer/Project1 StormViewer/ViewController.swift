...
class ViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        // sets navigation title to large titles and controllers that inherit ViewController
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        // this method will let us use a property from DetailVC by loading "Detail" which we set as the Storyboard ID for DetailVC. Then set a property inside of DetailVC then push it to DetailVC
